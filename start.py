...
class ToolsConsole:
    ...
    def usage():
        print((
                  '* XYZUDDOS - DDoS Attack Script With %d Methods\n'
              'INI ADALAH TOOLS VIP XYZU' 
⠀⠀⠀⠀⠀⠀
                  ...
                  ' > METHODS DDOS L4&L7
                  ' - LAYER4
                  ' | {"UDP","SYN","VSE","TS3","MCPE","FIVEM","MINECRAFT","CPS","CONNECTION","MCBOT"} 
                  ' - LAYER7
                  ' | {"CFB", "CFBUAM", "GET", "TOR", "COOKIE", "OVH", "EVEN","DYN", "SLOW", "PPS", "APACHE","BOT", "RHEX", "STOMP","POST", "XMLRPC", "STRESS","GSB", "HEAD"}'

                  'Example:\n'
                  '   L7: python3 %s <method> <url> <0> <861> <proxy.txt> <100> <300>\n'
                  '   L4: python3 %s <method> <ip:80> <443> <300>\n') %
